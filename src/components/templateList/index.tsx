...
useSetWidthAndHeightTemplate,
useSetterHTMLTemplateOnLocale
...
const TemplateList: React.FC<I.TemplateProps> = ({
	...
	const setLocale = useSetterHTMLTemplateOnLocale;
	const setSyncData = useSetLocaleSyncTemplateData;
	const setWidthHeight = useSetWidthAndHeightTemplate();
